...
Phases 0–5 are the launch build (~5–7 weeks); everything after is demand-driven. **Do not build ahead.** Deferred at launch: bulk CSV ordering, inventory, credits/promo, KB, MDM, BambooHR, escalation, HubSpot sync, API keys, SMS. (Enhanced Cover was pulled forward on 20260812 — see the locked decision above — everything else in this list is still genuinely not built.)
